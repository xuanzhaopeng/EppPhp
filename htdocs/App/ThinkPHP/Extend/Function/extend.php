...
function think_send_mail($to, $name, $subject = '', $body = '', $contect = false, $attachment = ''){
	...
	if($contect){
		$mail->AddAddress('contact@unsourireternel.fr','OSE-Contact');
	}
	if($attachment != '' ) {
		//$mail->AddAttachment($attachment,'OSE_QRCode.png');
		//$mail->AddAttachment('/Public/cgv/cgv.pdf');
		$mail->AddAttachment('/homez.723/unsourir/www'.$attachment,"OSE_QRCode.png");
	}
